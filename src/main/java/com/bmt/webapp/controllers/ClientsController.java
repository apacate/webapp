...
import com.bmt.webapp.services.ClientService;
...
import com.bmt.webapp.entities.ClientDto;
import com.bmt.webapp.entities.Invoice;
...
public class ClientsController {
    ...
    public String getClients(Model model) {
        ...
        Long totalClients = clientService.contarRegistros();
        model.addAttribute("totalClients", totalClients);

        int anoAtual = new Date().getYear() + 1900;  // Recupera o ano atual
        int mesAtual = new Date().getMonth() + 1;    // Recupera o mês atual

        Long clientsThisYear = clientService.contarClientesNoAno(anoAtual);
        Long clientsThisMonth = clientService.contarClientesNoMes(anoAtual, mesAtual);

        model.addAttribute("clientsThisYear", clientsThisYear);
        model.addAttribute("clientsThisMonth", clientsThisMonth);
